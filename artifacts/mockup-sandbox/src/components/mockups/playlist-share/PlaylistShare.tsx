    ...
    <div className="min-h-screen bg-[#070A10] font-sans">
      ...
      <div className="sticky top-0 z-50 bg-[#0C1018]/95 backdrop-blur border-b border-white/[0.06] px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-white text-[13px] font-semibold leading-tight truncate">Open in SkillSee</p>
          <p className="text-white/40 text-[11px]">View & save this playlist in the app</p>
        </div>
        <button
          className="px-4 py-1.5 rounded-full text-[13px] font-bold text-white flex-shrink-0"
          style={{ background: `linear-gradient(135deg, rgba(${rgb},1), rgba(${rgb},0.7))` }}
        >
          Open
        </button>
      </div>
      ...
      >
        {/* SkillSee badge */}
        <div className="flex items-center gap-1.5 bg-white/10 rounded-full px-3 py-1 mb-1">
      ...
      {/* Get the app card — Spotify-style */}
      <div className="px-4 mt-6">
        <div className="bg-[#0C1018] rounded-2xl p-5 border border-white/[0.06]">
          ...
          <p className="text-white/60 text-[13px] mb-4 leading-relaxed">
            Save this playlist to your library and track your progress through every resource.
          </p>
          {/* Save to library button */}
          <button
            className="w-full py-3.5 rounded-xl text-white font-bold text-[14px] mb-3"
          ...
          <div className="flex gap-2">
            <button className="flex-1 flex items-center justify-center gap-2 bg-white/[0.06] hover:bg-white/[0.1] transition-colors rounded-xl py-2.5 border border-white/[0.08]">
      ...
      <p className="text-center text-white/10 text-[11px] py-6">Made with SkillSee · Save. Learn. Master.</p>
    </div>
  );
}
